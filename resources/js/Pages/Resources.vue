...
<template>
    <Head title="Hola Profe" />
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="relarive overflow-x-auto, flex justify-center">
